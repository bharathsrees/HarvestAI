    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 animate-fade-in">
                <span className="text-harvest-primary">Smart Farming</span> with HarvestAI
              </h1>
              <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
                AI-powered tools to help farmers identify crop diseases, 
                track weather patterns, and connect directly with consumers.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                HarvestAI provides farmers with powerful tools to maximize productivity and profitability.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Link to="/weather" className="block hover:no-underline">
                <FeatureCard
                  ...
                  description="Access 3-day forecasts with smart irrigation recommendations based on local conditions."
                  icon={<Cloud size={24} />}
                />
              </Link>
              ...
              <Link to="/market" className="block hover:no-underline">
                <FeatureCard
                  title="Market Prices"
                  description="Track real-time crop prices and connect directly with consumers for better profits."
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900">Why Choose HarvestAI</h2>
              <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                Our platform is designed to address the unique challenges facing modern farmers.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Identify crop diseases before they spread to save your harvest.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Water Efficiency</h3>
                <p className="text-gray-600">Optimize irrigation based on weather patterns and soil conditions.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Better Profits</h3>
                <p className="text-gray-600">Get the best prices by tracking market trends and selling directly.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Make data-driven decisions to minimize environmental impact.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 harvest-gradient text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="max-w-2xl mx-auto text-lg mb-8">
              Join thousands of farmers already using HarvestAI to increase yields and profitability.
            </p>
